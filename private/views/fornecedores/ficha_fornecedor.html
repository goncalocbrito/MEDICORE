...
<head>
    ...
    <title>MEDICORE | Ficha do Fornecedor</title>
...
<body>
    ...
    <!-- =========================================================
         ...
         Navegação principal. O menu Fornecedores fica ativo nesta página.
         ========================================================= -->
            ...
            <div class="collapse navbar-collapse justify-content-center" id="menuPrivado">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item menu-dropdown-hover-fornecedores">
                        <a href="lista_fornecedores.html" class="nav-link active">
                        ...
                        <ul class="submenu-fornecedores">
                            <li>
                                <a href="lista_fornecedores.html">
                                    <i class="fa-solid fa-list me-2"></i> Lista de Fornecedores
                                </a>
                            </li>
                            <li>
                                <a href="novo_fornecedor.html">
    ...
    <main class="conteudo-private ficha-equipamento-page ficha-fornecedor-page">
        ...
        <div class="ficha-toolbar">
            <a href="lista_fornecedores.html" class="btn btn-voltar botao-consulta">
    ...
    <!-- =========================================================
         SCRIPTS DA PÁGINA
         Bootstrap ativa tabs/dropdowns e 1230404.js trata edição,
         documentos dinâmicos e pop-ups.
         ========================================================= -->
