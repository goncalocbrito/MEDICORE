...
<head>
    ...
    <title>MEDICORE | Novo Fornecedor</title>
...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item menu-dropdown-hover-fornecedores">
                        ...
                        <ul class="submenu-fornecedores">
                            ...
                            <li>
                                <a href="novo_fornecedor.html" class="submenu-active">
    ...
    <!-- =========================================================
         SCRIPTS DA PÁGINA
         Bootstrap ativa tabs/dropdowns e 1230404.js trata limpar,
         documentos dinâmicos e pop-up de sucesso.
         ========================================================= -->
