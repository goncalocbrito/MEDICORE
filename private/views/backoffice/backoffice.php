...
<head>
    ...
    <title>MEDICORE | Backoffice Página Pública</title>

    <!-- =========================================================
         RECURSOS DA PÁGINA
         Usa os mesmos recursos visuais da área privada MEDICORE.
         ========================================================= -->
...
<body>
    ...
    <!-- =========================================================
         ...
         Identifica o utilizador e mantém o padrão das restantes páginas.
         ========================================================= -->
            ...
            <div class="col-md-4 text-md-end p-3">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="perfil.php"><i class="fa-solid fa-user-gear me-2"></i> Perfil</a></li>
    ...
    <!-- =========================================================
         ...
         Mantém a navegação interna e destaca o backoffice público.
         ========================================================= -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="menuPrivado">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="backoffice.html" class="nav-link active">
                            <i class="fa-solid fa-pen-to-square me-2"></i> Página Pública
                        </a>
                    </li>
                </ul>
            </div>
