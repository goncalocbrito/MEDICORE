...
<head>
    ...
    <title>MEDICORE | Processos Finalizados</title>
...
<body>
    ...
    <!-- Menu horizontal com submenu de calibrações/manutenções. -->
            ...
            <div class="collapse navbar-collapse justify-content-center" id="menuPrivado">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item menu-dropdown-hover-calibracoes">
                        <a href="calibracao_manutencao.html" class="nav-link active">
                            <i class="fa-solid fa-screwdriver-wrench me-2"></i> Calibrações/Manutenções
                            <i class="fa-solid fa-chevron-down ms-1 small"></i>
                        </a>
                        <ul class="submenu-calibracoes">
                            <li><a href="calibracao_manutencao.html"><i class="fa-solid fa-list-check me-2"></i> Processos a Decorrer</a></li>
                            <li><a href="processos_finalizados.html" class="submenu-active"><i class="fa-solid fa-circle-check me-2"></i> Processos Finalizados</a></li>
                        </ul>
                    </li>
