...
<head>
    ...
    <title>MEDICORE | Localizações</title>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item menu-dropdown-hover-localizacoes">
                        ...
                        <ul class="submenu-localizacoes">
                            <li><a href="lista_localizacoes.html" class="submenu-active"><i class="fa-solid fa-list me-2"></i> Lista de Localizações</a></li>
                            <li><a href="nova_localizacao.html"><i class="fa-solid fa-plus me-2"></i> Adicionar Localização</a></li>
                        </ul>
                    </li>
