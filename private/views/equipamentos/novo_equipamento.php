...
<head>
    ...
    <title>MEDICORE | Novo Equipamento</title>

    <!-- =========================================================
         RECURSOS DA PÁGINA
         Nesta zona são carregados o favicon, Bootstrap, CSS próprio,
         fonte Titillium Web e ícones Font Awesome.
         ========================================================= -->
    ...
    <!-- CSS privado do projeto MEDICORE -->
...
<body>
    ...
    <!-- =========================================================
         ...
         Mantém o mesmo estilo visual usado na ficha_equipamento.html.
         ========================================================= -->
    ...
    <!-- =========================================================
         ...
         O separador Equipamentos fica ativo porque esta página pertence a esse módulo.
         ========================================================= -->
    <nav class="navbar navbar-expand-lg menu-horizontal">
        <div class="container-fluid">

            <!-- Botão hamburguer para ecrãs pequenos -->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item menu-dropdown-hover">
                        ...
                        <ul class="submenu-equipamentos">
                            ...
                            <li>
                                <a href="novo_equipamento.html" class="submenu-active">
    ...
    <!-- =========================================================
         SCRIPTS
         Bootstrap ativa os separadores, dropdowns e popovers.
         1230404.js mantém a descrição da criticidade e documentos dinâmicos.
         ========================================================= -->

    <!-- Bootstrap JS -->
    <script src="../../assets/bootstrap/bootstrap.bundle.min.js"></script>

    <!-- JavaScript privado do projeto MEDICORE -->
