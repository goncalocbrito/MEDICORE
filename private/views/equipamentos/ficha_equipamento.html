...
<head>
    ...
    <title>MEDICORE | Ficha do Equipamento</title>
...
<body>
    ...
    <!-- =========================================================
         ...
         Contém o logótipo, mensagem de boas-vindas e menu do utilizador.
         ========================================================= -->
    ...
    <!-- =========================================================
         ...
         Navegação principal do backoffice.
         ========================================================= -->
    <nav class="navbar navbar-expand-lg menu-horizontal">
        <div class="container-fluid">

            <!-- Botão hamburguer em ecrãs pequenos -->
            ...
            <div class="collapse navbar-collapse justify-content-center" id="menuPrivado">
                <ul class="navbar-nav">
                    ...
                    <!-- Menu Equipamentos ativo nesta página -->
                    <li class="nav-item menu-dropdown-hover">
                        ...
                        <ul class="submenu-equipamentos">
                            <li>
                                <a href="lista_equipamentos.html" class="submenu-active">
                    ...
                    <li class="nav-item menu-dropdown-hover-localizacoes">
                        ...
                        <ul class="submenu-localizacoes">
                            <li>
                                <a href="../localizacoes/lista_localizacoes.html">
                                    <i class="fa-solid fa-list me-2"></i> Lista de Localizações
                                </a>
                            </li>

                            <li>
                                <a href="../localizacoes/nova_localizacao.html">
                    ...
                    <li class="nav-item menu-dropdown-hover-fornecedores">
                        ...
                        <ul class="submenu-fornecedores">
                            ...
                            <li>
                                <a href="../fornecedores/novo_fornecedor.html">
    ...
    <!-- =========================================================
         ...
         A classe ficha-equipamento-page permite aplicar CSS específico
         só nesta página, sem afetar outras páginas.
         ========================================================= -->
    <main class="conteudo-private ficha-equipamento-page">

        <!-- =====================================================
             ELEMENTOS OCULTOS PARA COMPATIBILIDADE COM O JS
             Estes campos podem ser usados pelo JavaScript para atualizar
             títulos, badges ou resumo, mesmo que não apareçam no ecrã.
             ===================================================== -->
        <div class="d-none" aria-hidden="true">
            <h2 id="tituloPaginaEquipamento">Ficha do Equipamento</h2>
            <span id="resumoNomeEquipamento">Monitor Multiparamétrico</span>
            <span id="resumoDescricao">EQ-001 | Philips IntelliVue MX450 | Sala 2</span>
            <span id="badgeEstado">Ativo</span>
            <span id="badgeCriticidade">Criticidade: Crítica</span>
            <span id="badgeOperacional">Operacional</span>
        </div>
             
        <!-- Barra de ações da ficha.
        Em modo observação mostra Voltar à Lista + Editar.
        ...
        <div class="ficha-toolbar">
            ...
            <!-- Botões visíveis apenas no modo edição -->
        ...
        <!-- =====================================================
             FORMULÁRIO ÚNICO DA FICHA DO EQUIPAMENTO
             Este formulário serve para consulta e edição.
             
             Classes importantes:
             - campo-ficha: identifica todos os campos da ficha
             - campo-editavel: campos que podem ser editados ao clicar Editar
             - campo-bloqueado: campos que nunca devem ser alterados
             - botao-edicao: elementos que só aparecem em modo edição
             ===================================================== -->
        <form class="form-equipamento form-ficha-equipamento"
              id="formFichaEquipamento"
              action="processa_equipamento.php"
              method="post"
              enctype="multipart/form-data">

            <!-- Campos ocultos que ajudam o PHP a identificar o equipamento e o modo -->
            <input type="hidden" id="idEquipamento" name="idEquipamento" value="EQ-001">
            <input type="hidden" id="modoFormulario" name="modoFormulario" value="ver">


            <!-- =================================================
                 ÁREA PRINCIPAL DA FICHA
                 Contém a barra de separadores e o conteúdo de cada separador.
                 ================================================= -->
            <div class="ficha-area">

                <!-- =============================================
                     SEPARADORES BOOTSTRAP
                     Permitem organizar a ficha numa única página,
                     sem criar várias páginas diferentes.
                     ============================================= -->
                ...
                <!-- =============================================
                     ...
                     Cada .tab-pane corresponde a um separador.
                     ============================================= -->
                <div class="tab-content ficha-tab-content" id="tabsFichaEquipamentoContent">
                    ...
                    <div class="tab-pane fade show active"
                        ...
                        <div class="secao-ficha-titulo">
                            ...
                            <p>Dados principais de rastreabilidade do equipamento. O código interno deve ser único.</p>
                        </div>
                    ...
                    <!-- =========================================
                         ...
                         Define onde o equipamento está e em que estado se encontra.
                         ========================================= -->
                    <div class="tab-pane fade"
                        ...
                        <div class="secao-ficha-titulo">
                            ...
                            <p>Informação sobre a localização atual, estado operacional e criticidade clínica.</p>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select campo-ficha campo-editavel"
                                    ...
                                    <option value="Unidade de Cuidados Intensivos" selected>Unidade de Cuidados Intensivos</option>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select campo-ficha campo-editavel"
                                    ...
                                    <option value="Edifício A" selected>Edifício A</option>
                    ...
                    <!-- =========================================
                         ...
                         Informação administrativa, fornecedor e garantia.
                         ========================================= -->
                    <div class="tab-pane fade"
                         id="aquisicao"
                         role="tabpanel"
                        ...
                        <div class="secao-ficha-titulo">
                            ...
                            <p>Dados administrativos sobre aquisição, fornecedor associado e garantia.</p>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select campo-ficha campo-editavel"
                                    ...
                                    <option value="MedSupply Portugal" selected>MedSupply Portugal</option>
                    ...
                    <!-- =========================================
                         ...
                         Registo de manutenção, calibração e técnico responsável.
                         ========================================= -->
                    <div class="tab-pane fade"
                         id="manutencao"
                         role="tabpanel"
                        ...
                        <div class="secao-ficha-titulo">
                            ...
                            <p>Registo das datas principais de manutenção, calibração e responsável técnico.</p>
                        </div>
                    ...
                    <!-- =========================================
                         ...
                         Mostra documentos já associados e permite adicionar novos
                         quando a ficha entra em modo edição.
                         ========================================= -->
                    <div class="tab-pane fade"
                         id="documentos"
                         role="tabpanel"
                        ...
                        <div class="secao-ficha-titulo d-flex justify-content-between align-items-start gap-3 flex-wrap">
                            <div>
                                ...
                                <p>Documentação técnica, administrativa e ficheiros associados ao equipamento.</p>
                            </div>

                            <!-- Este botão só aparece em modo edição -->
                            <button type="button"
                        ...
                        <!-- Lista de documentos já associados ao equipamento -->
                        <div class="documentos-lista mb-4">

                            <div class="documento-item">
                                <div class="documento-info">
                                    <i class="fa-solid fa-file-pdf documento-icone"></i>
                                    <div>
                                        <h5>Manual de Instruções</h5>
                                        <p>Documento técnico com instruções de utilização do equipamento.</p>
                                    </div>
                                </div>
                            ...
                            <div class="documento-item">
                                <div class="documento-info">
                                    ...
                                    <div>
                                        <h5>Certificado de Calibração</h5>
                                        <p>Certificado associado à última calibração do equipamento.</p>
                                    </div>
                                </div>
                        ...
                        <!-- Área para novos documentos.
                             O primeiro bloco fica escondido até entrar em modo edição. -->
                    ...
                    <div class="tab-pane fade"
                        ...
                        <div class="secao-ficha-titulo">
                            ...
                            <p>Campo livre para informação relevante sobre o estado, histórico ou utilização do equipamento.</p>
                        </div>
                        ...
                        <textarea class="form-control campo-ficha campo-editavel"
                                  ...
                                  name="observacoes"
                                  rows="7"
                                  placeholder="Indique observações técnicas relevantes.">Equipamento operacional e com contrato de manutenção ativo. Sem ocorrências críticas registadas.</textarea>
                    </div>
