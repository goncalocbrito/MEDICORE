            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="menuPrivado">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="/MEDICORE/private/index.php" class="nav-link active">
                                <i class="fa-solid fa-chart-line me-2"></i> Dashboard Técnico
                            </a>
                        </li>

                        <li class="nav-item menu-dropdown-hover">
                            <a href="/MEDICORE/private/views/equipamentos/lista_equipamentos.php" class="nav-link">
                    ...
                    <li class="nav-item menu-dropdown-hover-calibracoes">
                        <a href="/MEDICORE/private/views/calibracao_manutencao/calibracao_manutencao.php" class="nav-link">
                        ...
                        <ul class="submenu-calibracoes">
                            <li>
                                <a href="/MEDICORE/private/views/calibracao_manutencao/calibracao_manutencao.php">
                                    <i class="fa-solid fa-list-check me-2"></i> Processos a Decorrer
                                </a>
                            </li>
                            <li>
                                <a href="/MEDICORE/private/views/calibracao_manutencao/processos_finalizados.php">
                        ...
                        <li class="nav-item menu-dropdown-hover-localizacoes">
                            <a href="/MEDICORE/private/views/localizacoes/lista_localizacoes.php" class="nav-link">
                        ...
                        <li class="nav-item menu-dropdown-hover-fornecedores">
                            <a href="/MEDICORE/private/views/fornecedores/lista_fornecedores.php" class="nav-link">
                    ...
                    <li class="nav-item menu-dropdown-hover-utilizadores">
                        <a href="/MEDICORE/private/views/utilizadores/lista_utilizadores.php" class="nav-link">
                    ...
                    <!-- Menu Backoffice -->
                    <li class="nav-item">
                        <a href="/MEDICORE/private/views/backoffice/backoffice.php" class="nav-link">
